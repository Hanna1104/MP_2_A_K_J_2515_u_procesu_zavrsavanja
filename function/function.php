...
function top_lista($slika,$naziv,$autor,$cena,$productid){
    $product="<form method=\"post\" action=\"./edicije.php\">".
            ...
            "<input type='hidden' name='product_id' value='$productid' />"."</div>"."</form>";
            return $product;
    }
...
function knjiga($slika,$naziv,$autor){
       $product=
                "<div class=\"knjige\">"."<div class=\"slika\">"."<img src='$slika' />"  . 
                "<h1>".$naziv."</h1>". 
                "<h4>".$autor."</h4>"."</div>"."</div>";
    return $product;
}
...
function showcart($slika,$naziv,$autor,$cena,$product_id){
    $product=
